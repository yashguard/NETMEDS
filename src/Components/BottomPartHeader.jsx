      ...
      <div className="menus">
        <ul className="row">
          <li className="row">
            ...
            <Link to="/Medicine" className="color1">
              Medicine
            </Link>
            <ol class="dropdown">
              <li>
          ...
          <li className="row">
            ...
            <Link to="/Wellness" className="color1">
              Wellness
            </Link>
            <a></a>
            <div class="mega-menu">
                ...
                <div class="w-20">
                  <div class="w-100">
                    <ul>
                      ...
                      <li>
                        <a>Mask, Gloves & Protective Equipment </a>
                      </li>
                      <li>
          ...
          <li className="row">
            ...
            <Link to="/LabTest" className="color1">
              Lab Test
            </Link>
            <a></a>
          </li>
          ...
          <li className="row">
            ...
            <Link to="/Beauty" className="color1">
              Beauty
            </Link>
          </li>
          ...
          <li className="row">
            ...
            <Link to="/HealthCornar" className="color1">
              Health Cornar
            </Link>
            <ol class="dropdown">
              <li>
...
export default BottomPartHeader;
